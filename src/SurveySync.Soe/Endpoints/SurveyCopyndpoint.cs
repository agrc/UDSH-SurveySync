...
namespace SurveySync.Soe.Endpoints {
    ...
    public class SurveyCopyndpoint : JsonEndpoint, IRestEndpoint {
        ...
        /// </summary>
        private const string ResourceName = "Copy";
                                     ...
                                     out string responseProperties)
        {
            ...
            try
            {
                buildings = CommandExecutor.ExecuteCommand(
                    new GetRecordsCommand(buildingsFeatureClass.FeatureClass, propertyIdWhereClause,
                                          ignores: new List<string> {"OBJECTID", "CONTRIBUTIONPROPERTYID", "SHAPE"}));
            }
            ...
            try
            {
                container =
                    CommandExecutor.ExecuteCommand(
                        new CreateApplyEditActionsForCopyCommand(contributionFeatureClass.Index, buildings));
            }
            ...
            var result =
                CommandExecutor.ExecuteCommand(new SendEditsToFeatureServiceCommand(container,
                                                                                    ApplicationCache.Settings.
                                                                                                     FeatureServiceEditingUrl));
